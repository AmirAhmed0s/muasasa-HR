...
def get_data(filters, show_party_name):
    ...
    # 1
    if (
        filters.get("party_type") == "Customer"
        and not filters.get("party")
        and filters.get("customer_group")
        and filters.get("payment_terms")
        and filters.get("territory")
    ):
        party_filters = {
            "territory": ["in", filters.get("territory")],
            "customer_group": ["in", filters.get("customer_group")],
            "payment_terms": ["in", filters.get("payment_terms")],
        }
    # 2
    if (
        filters.get("party_type") == "Customer"
        and not filters.get("party")
        and not filters.get("customer_group")
        and filters.get("payment_terms")
        and filters.get("territory")
    ):
        party_filters = {
    ...
    if (
        ...
        and not filters.get("party")
        and not filters.get("customer_group")
        and not filters.get("payment_terms")
        and filters.get("territory")
    ):
        party_filters = {
            "territory": ["in", filters.get("territory")],
